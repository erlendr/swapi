    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name='transport', to='resources.People'),
        ...
        migrations.AddField(
            ...
            name='characters',
            field=models.ManyToManyField(
                related_name='films', to='resources.People'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='film',
            name='planets',
            field=models.ManyToManyField(
                related_name='films', to='resources.Planet'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='film',
            name='species',
            field=models.ManyToManyField(
                related_name='films', to='resources.Species'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='film',
            name='starships',
            field=models.ManyToManyField(
                related_name='films', to='resources.Starship'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='film',
            name='vehicles',
            field=models.ManyToManyField(
                related_name='films', to='resources.Vehicle'),
            preserve_default=True,
        ),
    ]
