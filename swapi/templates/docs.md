...
Open up a terminal and use [curl](http://curl.haxx.se) or [httpie](http://httpie.org) to make an API request for a resource. In the example below, we're trying to get the first planet, Tatooine:
    ...
    https://spv-swapi.herokuapp.com/api/planets/1/
...
Here is the response we get:
    ...
    Content-Type: application/json
    {
        ...
        "population": "200000",
        "residents": [
            "https://spv-swapi.herokuapp.com/api/people/1/",
            "https://spv-swapi.herokuapp.com/api/people/2/",
            ...
        ],
        "rotation_period": "23",
        "surface_water": "1",
        "terrain": "Dessert",
        "url": "https://spv-swapi.herokuapp.com/api/planets/1/"
    }
...
The Base URL for swapi is:
    ...
    https://spv-swapi.herokuapp.com/api/
...
```
https://spv-swapi.herokuapp.com/api/people/?search=r2
```
...
```
https://spv-swapi.herokuapp.com/api/planets/1/?format=wookiee
```
...
**Example response:**
    ...
    Content-Type: application/json
    {
        "films": "https://spv-swapi.herokuapp.com/api/films/",
        "people": "https://spv-swapi.herokuapp.com/api/people/",
        "planets": "https://spv-swapi.herokuapp.com/api/planets/",
        "species": "https://spv-swapi.herokuapp.com/api/species/",
        "starships": "https://spv-swapi.herokuapp.com/api/starships/",
        "vehicles": "https://spv-swapi.herokuapp.com/api/vehicles/"
    }
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "starships": [
            "https://spv-swapi.herokuapp.com/api/starships/2/",
            ...
        ],
        "title": "A New Hope",
        "url": "https://spv-swapi.herokuapp.com/api/films/1/",
        "vehicles": [
            "https://spv-swapi.herokuapp.com/api/vehicles/4/",
            ...
        ]
    }
...
**Example request:**
    ...
    https://spv-swapi.herokuapp.com/api/starships/9/
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "url": "https://spv-swapi.herokuapp.com/api/starships/9/"
    }
...
**Example response:**
...

    {
        ...
        "url": "https://spv-swapi.herokuapp.com/api/vehicles/4/",
...
**Example request:**
    ...
    https://spv-swapi.herokuapp.com/api/species/3/
...
**Example response:**
...

    {
        ...
        "homeworld": "https://spv-swapi.herokuapp.com/api/planets/14/",
        "language": "Shyriiwook",
        "name": "Wookie",
        "people": [
            "https://spv-swapi.herokuapp.com/api/people/13/"
        ],
        "films": [
            "https://spv-swapi.herokuapp.com/api/films/1/",
        ...
        "skin_colors": "gray",
        "url": "https://spv-swapi.herokuapp.com/api/species/3/"
    }
