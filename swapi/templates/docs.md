...
Open up a terminal and use [curl](http://curl.haxx.se) or [httpie](http://httpie.org) to make an API request for a resource. In the example below, we're trying to get the first planet, Tatooine:
    ...
    http://swapi.westeurope.azurecontainer.io//api/planets/1/
...
Here is the response we get:
    ...
    Content-Type: application/json
    {
        ...
        "population": "200000",
        "residents": [
            "http://swapi.westeurope.azurecontainer.io//api/people/1/",
            "http://swapi.westeurope.azurecontainer.io//api/people/2/",
            ...
        ],
        "rotation_period": "23",
        "surface_water": "1",
        "terrain": "Dessert",
        "url": "http://swapi.westeurope.azurecontainer.io/api/planets/1/"
    }
...
The Base URL for swapi is:
    ...
    http://swapi.westeurope.azurecontainer.io/api/
...
```
http://swapi.westeurope.azurecontainer.io/api/people/?search=r2
```
...
```
http://swapi.westeurope.azurecontainer.io/api/planets/1/?format=wookiee
```
...
**Example response:**
    ...
    Content-Type: application/json
    {
        "films": "http://swapi.westeurope.azurecontainer.io/api/films/",
        "people": "http://swapi.westeurope.azurecontainer.io/api/people/",
        "planets": "http://swapi.westeurope.azurecontainer.io/api/planets/",
        "species": "http://swapi.westeurope.azurecontainer.io/api/species/",
        "starships": "http://swapi.westeurope.azurecontainer.io/api/starships/",
        "vehicles": "http://swapi.westeurope.azurecontainer.io/api/vehicles/"
    }
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "eye_color": "Blue",
        "films": [
            "http://swapi.westeurope.azurecontainer.io/api/films/1/",
            ...
        ],
        "gender": "Male",
        "hair_color": "Blond",
        "height": "172",
        "homeworld": "http://swapi.westeurope.azurecontainer.io/api/planets/1/",
        "mass": "77",
        "name": "Luke Skywalker",
        "skin_color": "Fair",
        ...
        "species": [
            "http://swapi.westeurope.azurecontainer.io/api/species/1/"
        ],
        "starships": [
            "http://swapi.westeurope.azurecontainer.io/api/starships/12/",
            ...
        ],
        "url": "http://swapi.westeurope.azurecontainer.io/api/people/1/",
        "vehicles": [
            "http://swapi.westeurope.azurecontainer.io/api/vehicles/14/"
            ...
        ]
    }
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "starships": [
            "http://swapi.westeurope.azurecontainer.io/api/starships/2/",
            ...
        ],
        "title": "A New Hope",
        "url": "http://swapi.westeurope.azurecontainer.io/api/films/1/",
        "vehicles": [
            "http://swapi.westeurope.azurecontainer.io/api/vehicles/4/",
            ...
        ]
    }
...
**Example request:**
    ...
    http://swapi.westeurope.azurecontainer.io/api/starships/9/
...
**Example response:**
    ...
    Content-Type: application/json
    {
        ...
        "url": "http://swapi.westeurope.azurecontainer.io/api/starships/9/"
    }
...
**Example response:**
...

    {
        ...
        "url": "http://swapi.westeurope.azurecontainer.io/api/vehicles/4/",
...
**Example request:**
    ...
    http://swapi.westeurope.azurecontainer.io/api/species/3/
...
**Example response:**
...

    {
        ...
        "homeworld": "http://swapi.westeurope.azurecontainer.io/api/planets/14/",
        "language": "Shyriiwook",
        "name": "Wookie",
        "people": [
            "http://swapi.westeurope.azurecontainer.io/api/people/13/"
        ],
        "films": [
            "http://swapi.westeurope.azurecontainer.io/api/films/1/",
            "http://swapi.westeurope.azurecontainer.io/api/films/2/"
        ],
        "skin_colors": "gray",
        "url": "http://swapi.westeurope.azurecontainer.io/api/species/3/"
    }
